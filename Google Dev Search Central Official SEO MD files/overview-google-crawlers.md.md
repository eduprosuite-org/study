...
|---|---|
| [Common crawlers](https://developers.google.com/crawling/docs/crawlers-fetchers/google-common-crawlers) | The common crawlers used for Google's products (such as [Googlebot](https://developers.google.com/search/docs/crawling-indexing/googlebot)). They always respect robots.txt rules for automatic crawls. |
